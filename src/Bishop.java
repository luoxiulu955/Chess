...
public class Bishop extends Piece {
	...
	private final static int[][] RULES = {{1, 1}, {1, -1}, {-1, 1}, {-1, -1}};	//rules of move
			
	/**
	 * Initialize Bishop object and call to super()
	 * @param id	id of piece
	 * @param position	current position of piece
	 * @param alive	status of piece
	 * @param color	color of piece
	 */
	public Bishop(int id, int position, boolean alive, PColor color) {
		super(id, position, alive, color, PType.BISHOP);
	}

	/**
	 * Get the valid moves of bishop
	 */
	@Override
